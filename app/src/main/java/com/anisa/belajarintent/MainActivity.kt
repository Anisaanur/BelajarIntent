package com.anisa.belajarintent
...
import com.anisa.belajarintent.PindahDataObjekActivity.Companion.EXTRA_CARS
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.btn_pindah_objek -> run {
                ...
                val intentObjek = Intent(this@MainActivity, PindahDataObjek::class.java)
                intentObjek.putExtra(PindahDataObjek.EXTRA_CARS, cars)
